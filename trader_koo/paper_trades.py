...
PAPER_TRADE_CORE_ALLOCATION_PCT = float(os.getenv("TRADER_KOO_PAPER_TRADE_CORE_ALLOCATION_PCT", "70.0"))
PAPER_TRADE_SATELLITE_ALLOCATION_PCT = float(os.getenv("TRADER_KOO_PAPER_TRADE_SATELLITE_ALLOCATION_PCT", "30.0"))
...
def _build_config() -> PaperTradeConfig:
    return PaperTradeConfig(
        ...
        core_allocation_pct=PAPER_TRADE_CORE_ALLOCATION_PCT,
        satellite_allocation_pct=PAPER_TRADE_SATELLITE_ALLOCATION_PCT,
