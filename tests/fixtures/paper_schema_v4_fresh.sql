...
CREATE TABLE paper_portfolio_snapshots (
            ...
            created_ts TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, sortino_ratio REAL, calmar_ratio REAL, starting_capital REAL, cash REAL, equity REAL, realized_pnl_usd REAL, unrealized_pnl_usd REAL, gross_exposure_usd REAL, gross_exposure_pct REAL, high_water_equity REAL, drawdown_pct REAL, session_pnl_usd REAL, legacy_unreconciled_count INTEGER NOT NULL DEFAULT 0, accounting_breaks_json TEXT NOT NULL DEFAULT '[]',
